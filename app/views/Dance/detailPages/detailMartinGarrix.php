...
$generateArtistDetail = $artistDetailService->generateDanceArtistDetailHtml('Martin Garrix');
$eventsTable = $artistDetailService->generateArtistDetailTableDance('Martin Garrix');
?>
<p class="title">
    Dance
</p>
...
<?php
    ...
    <div class="container">
        ...
        <div class="headerDetails">
            <div class="row">
                <div class="col">
                    ...
                    <img class="HeaderImage" src="<?php echo $generateArtistDetail->getSecondImage() ?>">
                </div>
                <div class="col">
        ...
        <div class="mt-5">
            <div class="row">
                <div class="col-sm-4">
                    <img src="<?php echo $generateArtistDetail->getFirstImage() ?>">
                </div>
                <div class="col-sm-8">
