...
$generateArtistDetail = $artistDetailService->generateDanceArtistDetailHtml('Tiesto');
$eventsTable = $artistDetailService->generateArtistDetailTableDance('Tiesto');
?>
<p class="title">
    Dance
</p>
                ...
                <div class="row">
                    <div class="col">
                        <div class="image-container">
                            <img src="/../images/Dance/detailPages/inMyMemory.png" alt="" width="250px">
                    ...
                    <div class="col">
                        <div class="image-container">
                            <img src="/../images/Dance/detailPages/silence.png" alt="" width="250px">
                            <div class="button-container">
                                <button onclick="playPause()"><i class="fas fa-play"></i> / <i
                                        class="fas fa-pause"></i></button>
                                <button onclick="muteUnmute()"><i class="fas fa-volume-up"></i> / <i
                    ...
                    <div class="col">
                        <div class="image-container">
                            <img src="/../images/Dance/detailPages/tiesto.png" alt="" width="250px">
                            <div class="button-container">
                                <button onclick="playPause()"><i class="fas fa-play"></i> / <i
                                        class="fas fa-pause"></i></button>
                                <button onclick="muteUnmute()"><i class="fas fa-volume-up"></i> / <i
                    ...
                    <div class="col">
                        <div class="image-container">
                            <img src="/../images/Dance/detailPages/elements.png" alt="" width="250px">
                            <div class="button-container">
                                <button onclick="playPause()"><i class="fas fa-play"></i> / <i
                                        class="fas fa-pause"></i></button>
                                <button onclick="muteUnmute()"><i class="fas fa-volume-up"></i> / <i
