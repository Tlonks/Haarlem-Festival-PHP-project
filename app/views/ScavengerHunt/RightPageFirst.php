...
<body>
    ...
    <main>
        ...
        <div id="correctText">
            <p id="textR">
                Correct!<br>
                Clue: Search the library for an book called The hidden word in the next room.
            </p>
        ...
        <div id="explanation">
            <p id="explText">
                Explanation:<br>
                By submersing the eggs under water they will either float or sink. If the egg sinks it is fresh. If the
                egg floats it has gone bad. When an egg gets older oxygen goes through the shell. Because there is
                oxygen in the egg it floats!
            </p>

        </div>

        <h3 id="codeText">
            Get the code from Dr. Feathers
        </h3>
        ...
        <form action="/FirstChallenge/firstRight" method="post">
