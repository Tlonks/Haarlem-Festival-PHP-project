...
<body>
    ...
    <main>
        ...
        <h2 id="challengeInfo">
            Find the 5 numbers in the surrounding rooms.
        </h2>

        <h3 id="answerLabel">
            Using the 5 numbers found calculate the answer and write it down:
        </h3>

        <form action="/SecondChallenge/secondAnswer" method="post">
        ...
        <div id="hide">Hint: Start from the lowest number.</div>
        <div id="hide2">Hint: First multiply, Divide, Add, Substract.</div>
