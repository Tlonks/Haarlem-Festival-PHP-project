...
<body>
    ...
    <main>
        ...
        <div id="wrongText">
            <p id="textWr">
                Oh no that is not the right answer!<br>
                Try again by pressing the button below:
            </p>

        </div>

        <div id="returnButtonLoc">
            <a href="/SecondChallenge/secondAnswer">
                <button id="returnButton" type="button" class="btn">&#8592;</button>
            </a>
        </div>
